...
//   //       obj.EmployerImg = `employer/${req.file.filename}`;
//   //     }
...
//   //     // Since you're using upload.any(), check req.files
//   //       if (req.file) {
//   //       console.log(req.file.filename);
//   //       obj.EmployerImg = `employer/${req.file.filename}`;
//   //     } else {
...
//       // Now correctly checking req.file (single upload)
//       if (req.file) {
        ...
        try {
          ...
          if (userData.phone) {
            await send.sendInterviewDetails(
              name,
              userData.phone,
              whatsappDetails?.Date,whatsappDetails?.Time,whatsappDetails?.Duration,whatsappDetails.Platform,whatsappDetails.Link,whatsappDetails?.Password,whatsappDetails?.Note
            );
          }
